...
class MBConvBlock(nn.Module):
	...
	def __init__(self, block_args, global_params):
		...
		if global_params.max_channels is not None:
			oup = min(global_params.max_channels,oup)
...
class EfficientNet(BaseModel):
	...
	"""
	def __init__(self, blocks_args=None, global_params=None, block=MBConvBlock):
		super().__init__()
		...
		self._conv_stem = Conv2dSamePadding(3, out_channels, kernel_size=3, stride=2, bias=False)
		...
		for block_args in self._blocks_args:
			...
			self._blocks.append(block(block_args, self._global_params))
